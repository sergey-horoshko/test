export default {
  root: ({ props, state, parent }) => ({
    class: [
      ...
      { 'bg-surface-0 dark:bg-dark-content': !props.disabled },

      'border',
      { 'dark:hover:border-gray-300': parent.instance.$name != 'InputGroup' },
      { 'dark:hover:border-gray-300': parent.instance.$name == 'InputGroup' },
      { 'border-surface-300 dark:hover:border-gray-400': !props.invalid },
      ...
      // States
      { 'hover:border-surface-400 dark:hover:border-gray-300': !props.invalid },
      {
  ...
  panel: {
    class: [
      ...
      // Shape
      'border border-surface-300 dark:border-gray-400',
      'rounded-md',
      'shadow-md',
    ],
  },
  ...
  header: {
    class: [
      ...
      'text-surface-700 dark:text-white/80',
      'bg-surface-0 dark:bg-surface-900',
      'border-surface-300 dark:border-gray-400',
    ],
  },
  filtercontainer: {
    class: 'relative',
